		...
		<div class="itemdiv dialogdiv replyLi" data-rno={{rno}}>
			...
			<div class="body">
				...
				<div class="time">
					...
					<a class="btn btn-primary btn-xs "  id="modifyReplyBtn"  style ="display:{{loginUserCheck replyer}};" data-replyer={{replyer}} data-toggle="modal" data-target="#modifyModal">Modify</a>
