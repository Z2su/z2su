...
<form id="modifyForm" class="form-horizontal"  method="post" >
	...
	<div class="form-group">
		...
		<div class="col-xs-8 col-sm-4 g_value">			
			<input id="writer" name="writer" style="width:70%;" class="form-control required" type="text" value="${board.writer }" readonly/>			
		</div>		
	</div>
	<div class="form-group" style="display:;">
		...
		<div class="col-xs-8 col-sm-10 g_value">
			<input id="bbs.category" name="bbs.category" type="hidden" value=""/>
	...
	<div class="form-group openDate" style="display:${category eq 'free' ? 'none':'block'};"><!-- 2018-01-18 게시기간 사용안함 -->
...
<div class="bline"></div>
<div id="upload" class="upload" style="background-color:#f9f9f9; height:166px; max-height:166px; border:1px solid  #6fb3e0; border-radius:2px; display:${category eq 'free' ? 'none':'block'};">
