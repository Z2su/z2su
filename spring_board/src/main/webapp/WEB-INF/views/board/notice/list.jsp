...
<body class="no-skin">
										...
										<table class="ui-jqgrid-htable ui-common-table " role="presentation" aria-labelledby="gbox_grid-table">
											<thead style="visibility: visible;">
												...
												<th class="ui-th-column ui-th-ltr ui-state-default" style="width:5%;">
														<div class="ui-jqgrid-sortable">중요쓰</div>
													</th>
													<th class="ui-th-column ui-th-ltr ui-state-default" style="width:5%;">
										...
										<div></div>
											<table id="grid-table" tabindex="0" role="presentation" aria-multiselectable="false" aria-labelledby="gbox_grid-table" class="ui-jqgrid-btable ui-common-table">
													...
													<tr role="row" class="jqgrow ui-row-ltr ui-widget-content">
														...
														<td role="gridcell" style="text-align:center;" >${point.nno }</td>
														<td role="gridcell" >
															<a href="#" onclick="OpenWindow('detail?nno=${point.nno }','','852','620')"
															   style='<c:if test="${point.viewcnt >= 5}" >font-weight:bold;color:blue;</c:if>'>${point.title } 
														...
														<td role="gridcell" style="text-align:center;" >${point.viewcnt }</td>
													</tr>
													</c:forEach>
													...
													<tr role="row" class="jqgrow ui-row-ltr ui-widget-content">
													 <td role="gridcell" style="text-align:center;" >
														...
														<td role="gridcell" >
															<a href="#" onclick="OpenWindow('detail?nno=${notice.nno }','','852','620')"
	...
	<%@ include file="/WEB-INF/views/board/notice/list_js.jsp" %>
