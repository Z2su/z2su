...
<form id="registForm" class="form-horizontal" action="/upload" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<div class="col-xs-8 col-sm-4 g_value">			
			<input id="writer" name="writer" style="width:70%;" class="form-control required" type="text" value="${loginUser.id }" readonly/>			
		</div>		
	</div>
	...
	<div class="form-group openDate" style="display: visible;"><!-- 2018-01-18 게시기간 사용안함 -->
		...
		<div class="col-xs-8 col-sm-10 g_value">
			<input id="startDate" name="startDate" style="color:#919191;" class="dateInput" readonly="readonly" type="text" value="2019-05-30"/>
				~
			<input id="endDate" name="endDate" class="dateInput" readonly="readonly" type="text" value="2019-06-30"/>
